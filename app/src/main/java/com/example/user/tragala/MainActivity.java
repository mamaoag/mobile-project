package com.example.user.tragala;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static Button button_SI;
    ...
    public void onClickButtonListener(){
        button_SI =(Button)findViewById(R.id.bSignIn);
        button_SI.setOnClickListener(
              new View.OnClickListener(){

        @Override
            public void onClick(View v){
            Intent intent = new Intent("com.example.user.tragala.LoginActivity");
